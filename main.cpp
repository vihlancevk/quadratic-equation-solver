...
//!
//! @note пользователь поочередно вводит коэффициенты a, b и с соответственно квадратного уравнения вида a*x^2 + b*x + c = 0;
//!       после ввода одного из коэффициентов ему необходимо нажать Enter, чтобы перейти к вводу другого или закончить его,
