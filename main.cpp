...
//!
//! @note пользователь вводит значение коэффициента, который обозначается символом coefficientSymbol;
...
//!
//! @warning в случае, если в ходе выполнения программы на вход данной функции придёт параметр rootsCount с недопустимым
//!          для него значением (допустимые значения: 0, 1, 2, INF_ROOTS (=-1)), то на консоль будет выведенно сообщение об ошибке:
